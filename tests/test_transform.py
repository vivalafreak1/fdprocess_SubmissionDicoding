...
def test_transform_success():
    raw = [{"Title":"A","Price":"$2.50","Rating":"3.5 / 5","Colors":"2 Colors","Size":"Size: L","Gender":"Gender: M","Timestamp":"2025-10-22T00:00:00"}]
...
def test_transform_filter_invalid():
    raw = [{"Title":"Unknown Product","Price":"Price Unavailable","Rating":"Invalid","Colors":"0 Colors","Size":"Size: ?","Gender":"Gender: ?","Timestamp":"2025-10-22T00:00:00"}]
    assert transform_data(raw).empty

def test_clean_price_non_string():
    s = pd.Series([np.nan, np.nan])
    assert clean_price(s).isna().all()
